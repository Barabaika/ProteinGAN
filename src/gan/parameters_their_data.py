...
MODEL_TYPE = 'sngan'
DATASET = 'Length_512_lab_test_37_v2'
CURRENT_DIRECTORY = os.path.dirname(__file__)

flags.DEFINE_string('dataset', DATASET+ "",
                    'Dataset to use for training. [diff_data_train]')
...
flags.DEFINE_integer('steps', int(1e6), 'Number of steps to train')
flags.DEFINE_string('running_mode', 'train', 'Running types [train, test]')
flags.DEFINE_string('name', 'diff_data_trained', 'A name of the model which will be used to construct folder name for weights')
...
flags.DEFINE_float('variation_level', 10.0, 'Hyper parameter of loss which controls variation. [10]')
flags.DEFINE_float('label_noise_level', 0.05, 'Hyper parameter of noise level for label swapping. [0.05]')
